...
{
    public static class CustomerAgentPlayground
    {
        // agent metadata 
        ...
        public static void Run()
        {
            ...
            var auth = new HubsterAuthClient(hostUrl: "http://localhost:5000", onAuthorizationRequest: (authClient) =>
            {
            ...
            var client = new HubsterDirectClient("http://localhost:8251");
            ...
            {
                var issues = JsonConvert.SerializeObject(conversationResponse.Errors, Formatting.Indented);
                Display(issues, ConsoleColor.Yellow);
